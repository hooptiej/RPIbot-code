    ...
    while loop > 0:
        ...
        for event in pygame.event.get(): # User did something
            if event.type == pygame.JOYBUTTONDOWN:
                ...
                button0 = str(pygame.joystick.Joystick(0).get_button(0))
                button1 = str(pygame.joystick.Joystick(0).get_button(1))
                button2 = str(pygame.joystick.Joystick(0).get_button(2))
                button3 = str(pygame.joystick.Joystick(0).get_button(3))
                button4 = str(pygame.joystick.Joystick(0).get_button(4))
                button5 = str(pygame.joystick.Joystick(0).get_button(5))
                button6 = str(pygame.joystick.Joystick(0).get_button(6))
                button7 = str(pygame.joystick.Joystick(0).get_button(7))
                button8 = str(pygame.joystick.Joystick(0).get_button(8))
                button9 = str(pygame.joystick.Joystick(0).get_button(9))
